...
export const saveUserProfile = async (
  ...
  try {
    const response = await fetch(`${API_URL}api/client/profile/update/${id}`, {
      method: "PUT",
      headers: {
        ...FETCH_HEADERS,
...
export const saveUserAvatar = async (
  ...
  try {
    const response = await fetch(`${API_URL}api/client/avatar/update/${id}`, {
      method: "POST",
      headers: {
        ...FETCH_HEADERS,
        Authorization: `Bearer ${token}`,
...
export const removeUserAvatar = async (
  ...
  try {
    const response = await fetch(`${API_URL}api/client/avatar/remove/${id}`, {
      method: "POST",
      headers: {
        ...FETCH_HEADERS,
        Authorization: `Bearer ${token}`,
...
export const changeUserConfig = async (
  ...
  try {
    const response = await fetch(`${API_URL}api/client/config/${id}`, {
      method: "PUT",
      headers: {
        ...FETCH_HEADERS,
        Authorization: `Bearer ${token}`,
